...
<template>
    <div class="min-h-[100svh] flex flex-col pt-28 items-center bg-gradient-to-b relative from-yellow-100/70 to-gray-300 overflow-hidden" id="couple">
        <img src="./../assets/blue-flower-2.png" alt="Blue FLower" class="h-48 absolute -top-10 -right-10">
        <h2 class="text-3xl font-cursive text-center">Undangan Pernikahan</h2>
